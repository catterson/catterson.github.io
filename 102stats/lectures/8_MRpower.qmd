...
**Look at the regression output in the lecture document to answer these questions.** These data come from the Salaries dataset, part of the car package : library(car).

You will need to click through the different tabs to view all three models (and Model 1 regression diagnostic).
