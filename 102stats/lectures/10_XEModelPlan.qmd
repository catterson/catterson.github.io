...
```{r}
mod1 <- lm(scale(Social.support) ~ scale(GDP), data = h)
mod2 <- lm(scale(Social.support) ~ scale(happiness), data = h)
mod3 <- lm(scale(Social.support) ~ scale(GDP) + scale(happiness), data = h)
mod4 <- lm(scale(Social.support) ~ scale(happiness) * scale(GDP), data = h)
