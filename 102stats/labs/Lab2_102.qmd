...
1.  Load the "honor onboarding" survey into R and answer the following questions. 
...
4.  **Self-Esteem Problems. Use the self-esteem dataset (from the class datasets folder). You should find a codebook that describes these data in the same folder.**
...
5.  **Challenge Problem (Optional, but Encouraged!)** Report the mean and standard deviation of self-esteem for people who identified as female, male, and "other" in the dataset. What differences between these three groups do you observe? How might we use this knowledge / what other questions do you have?
