...
The goal of this lab is to get practice working in Quarto, and describing data using R and your human brain.

Download this file as a .qmd from the course page, and open it up in RStudio.

Note : you may need to [install Quarto](https://quarto.org/docs/get-started/).
...
2.  Load the "honor onboarding" survey into the code block below, and answer the following questions. *Note : to successfully render code in the document, you must a) explicitly load the dataset into your Quarto document and b) make sure you have no errors in your code. :)*
...
[Here's an overview (from my 101 class notes) of how to work with such likert scales conceptually and computationally (in R)](https://catterson.github.io/ystats/chapters/4R_Scales.html). You'll need to load the psych library into R; to do this, run the following code in your console.
...
6.  **Challenge Problem (Optional, but Encouraged!)** Report the mean and standard deviation of self-esteem for people who identified as female, male, and "other" in the dataset. What differences between these three groups do you observe? How might we use this knowledge / what other questions do you have?
