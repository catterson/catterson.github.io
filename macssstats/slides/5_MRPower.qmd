...
[CHECK-IN : Interpreting NHST](https://docs.google.com/forms/d/e/1FAIpQLSejuhovb8Fb5hKUMRLaNJPdEw5NzjgRem3457dgokkhZ6hYAw/viewform?usp=header). Click here, and use the tabs below to answer!
...
### Dealing With Interaction Effects {.smaller}
...
### goal : you want power to be HIGH / LOW / NEUTRAL {.smaller}

::: {.callout-note collapse="true"}
#### What would increase power??? (spoilers)
...
the t-distribution approaches the normal distribution (with a 95% Interval cutoff of 1.96....) but we are not quite there so good to look up what the t-value actually is.
