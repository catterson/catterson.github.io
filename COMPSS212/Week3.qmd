...
::: {.column width="50%"}
**Goals this Week**
- **Check-In and Review :** Extend our understanding of likert scales and interpreting linear models.
- **New Stuff :** Making up data to estimate sampling error (bootstrapping)
:::

::: {.column width="50%"}
**Agenda**
- **10:10 - 11:00.** Check-In and Week 2 Review
- **11:00 - 11:10 :** BREAK TIME
- **11:10 - 12:00 :** Sampling Error with Bootstrapping
:::
:::::
::::::
...
- [**Check-In : Happy World**](https://forms.gle/Kou9Dq2Jdh8p8Kzv6) **:** Welcome back!! Please work in R to answer these questions. Ask for help if you are stuck!
...
- [**Bonus Notes.**](/COMPSS212/workbooks/3_BootstrapWork.html) A workbook we will go through together. 
