...
<iframe src="https://www.loom.com/embed/1459ad1569d64f6eaf6456b223a70e4a" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
...
1.  [**Why Statistics Chapter 2 (Parts 1 and 2).**](https://catterson.github.io/ystats/chapters/2R_Data.html) In this chapter, you'll learn how to work with collections of variables organized into datasets, and practice thinking about what you observe from a graph.
2.  *Note : Just one chapter this week. You can skip Part 3 of Chapter 2, though feel free to read!*
...
- **I am pretty sure there are no errors in the quiz!** Make sure you are following the "3 steps" for loading data (changing the name, checking headers, and setting stringAsFactor = TRUE)

- **Videos from Chapter 2 :**

  - [navigating a dataset in R](https://www.youtube.com/watch?v=TaonMS3b0pU)

  - [navigating data with indexing](https://www.youtube.com/watch?v=js2vV5P4DSQ)

  - [loading a dataset into R](https://www.youtube.com/watch?v=XLew6OeYAm0) + [loading data into posit.cloud](https://www.youtube.com/watch?v=HOhINtpyjT4)

  - [practice quiz key](https://www.youtube.com/watch?v=cfeogtcAhNM) (make sure to try the practice quiz before watching the video)

**Questions and Resources from Week 1**

- **I want to [change my name on bCourses](https://berkeley.service-now.com/kb_view.do?sys_kb_id=f0ffee05dba159108a95bc04b99619ea)!** To be clear, all students should feel free to use whatever name they want, so don't feel like you *need* to change your name for any reason other than you prefer that. However, here are instructions if you would prefer to change how your name appears on bCourses.

- **Office Hours Question : What's the difference between "continuous" and "numeric" data???.** I discuss this more in Chapter 2, however :
  ...
  - in practice :
    ...
    - **this summer :** good to differentiate between numeric data and categorical data, since this will influence the R commands we use for graphing (e.g., plot vs. hist), the descriptive statistics that we use (week 3), and the linear models that we use (weeks 4 and 5).

    - **in the fall semester:** we will learn how to measure data continuously, and we will learn more how the type of number will influence the type of data analysis and methods that we use.
