...
[Check-In : Interpreting A Multivariate Regression Table](https://docs.google.com/forms/d/e/1FAIpQLSdosJZ27aIXCg6EiC_q_dd2hCGzR4j_auFi4ajlEGhZ-wIlig/viewform?usp=header)

*Note : number of friends = facebook friends; numbers in parentheses are standard [errors]{.underline}.*

![](images/clipboard-867791882.png){width="80%"}
...
::: {.column width="60%"}
![](images/clipboard-2212237259.png)
:::
:::::
...
### Multiple Regression : Visualized in Multi-Dimensional Space!{.smaller}
...
### Reporting Effects in a Regression Table.{.smaller}
