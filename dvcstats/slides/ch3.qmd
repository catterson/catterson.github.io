...
The histogram organizes the data, but you can see the same patterns in both graphs. **The Mean = `r mean(m$familysize[m$familysize < 24], na.rm = T)`**
...
plot(m$familysize[m$familysize < 24], ylab = "Family Size (# of Persons)")
abline(h = mean(m$familysize[m$familysize < 24], na.rm = T), col = 'red', lwd = 5)
hist(m$familysize[m$familysize < 24], xlab = "Family Size (# of Persons)", main = "")
