...
-   how would the variables (below) help (or not) predict country happiness in 2024? 
-   what other variables might be important to include in the data?
...
summary(mod)$r.squared # this is called R^2
```
::::::
