...
## [Vision Board : Q1 (Models & Me-Search)](https://docs.google.com/spreadsheets/d/14u3w5edvo6KSFRw2U9t1knDANFSGBWOvDjS7-ZGujos/edit?usp=sharing) {.smaller}

-   PROFESSOR SAYS : Simple Models, Complex Models, Clarified Models, Oh My!
-   WITH A BUDDY : what was your model? how would you clarify or simplify (or complicate) this model?

## [Vision Board : Q2 (Cognitive Biases) ](https://docs.google.com/spreadsheets/d/14u3w5edvo6KSFRw2U9t1knDANFSGBWOvDjS7-ZGujos/edit?usp=sharing) {.smaller}

CHAOS MODE : Find people who wrote about the same bias as you.

-   What's a TLDR for this bias?
-   What's a sentence that confused you?
-   What's an example that helps you understand?
...
::: {.column width="40%"}
## [Vision Board : WE DON'T HAVE TIME TO READ, PROFESSOR](https://docs.google.com/spreadsheets/d/14u3w5edvo6KSFRw2U9t1knDANFSGBWOvDjS7-ZGujos/edit?usp=sharing) {.smaller}

-   How are you feeling as you look at this document?
-   Abstract --\> Headers --\> What looks interesting? Confusing??
:::
:::::

# NEXT WEEK : WE HAD TIME TO READ, PROFESSOR! {.smaller}

1.  Do a closer reading of the "Objectivity Interrogation" article. Okay not to understand everything; we will discuss!

2.  Learn about reliability and validity and why phrenology was hella racist bad science.
