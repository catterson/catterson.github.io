...
### Check-In : Survey –\> Poster Template {.smaller}

::::: columns
::: {.column width="70%"}
-   **Do the check-in.** Thanks for a great semester!
-   **Final Project Time :**
    -   Look over our [poster template](https://docs.google.com/presentation/d/12vZTjpoXdL0tRVkxrvv1aVmKC657HUuzKng0mg9COPI/edit?usp=sharing).
    -   Grab one of the posters that professor is handing out.
    -   Chat with a buddy about the poster examples:
        -   what is the model that defines the research topic?
        -   how does the poster compare to the template?
        -   which of your topics seems more interesting?
        -   which poster seems more effective? why??
:::

::: {.column width="30%"}
![](images/clipboard-1038042391.png){width="80%"}
:::
:::::
...
::: {.column width="50%"}
-   how does the poster compare to the template?
-   what characteristics of the poster seem more or less effective?
-   other questions you have about this *genre* of scientific research?
:::
...
-   [**Poster Template**](https://docs.google.com/presentation/d/12vZTjpoXdL0tRVkxrvv1aVmKC657HUuzKng0mg9COPI/edit?usp=sharing)
    ...
    -   create a copy to your Google Drive.

    -   share the copy and add this to the Vision Board.
