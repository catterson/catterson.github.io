...
2.  Download the DescribingDataTutorial.qmd file to your computer.
3.  Upload this to posit.cloud.
4.  Open it in posit.cloud by clicking on the file (it is a fancy R Script).
5.  Check in on your buddy. How are they doing? How are you doing?
