...
::: {.column width="40%"}
**DISCUSSION :** consider the variable *happiness* in terms of its AFFECT, BEHAVAIOR, and COGNITION. Which are you more interested in?
:::
:::::
...
::::: columns
::: {.column width="50%"}
scientists make educated guesses about the future based on the knowledge they gain.
...
::::: columns
::: {.column width="60%"}
scientists also try to change the future based on their scientific predictions.
:::
