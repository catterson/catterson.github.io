---
title: "Lecture 1 | Why Statistics?"
format: html
#format: revealjs
#chalkboard: true
---
...
**access these lecture notes here :**
...
+----------------------------------------------------------+-------------------------------+
| ![](lecture_images/1L_blm.png){width="600"}[^2]          |                               |
+----------------------------------------------------------+-------------------------------+
...
[^2]: Oscar Grant, Trayvon Martin, Philando Castile, Eric Garner, George Floyd, Tamir Rice, Breonna Taylor, Ahmaud Aubrey, Jacob Blake. Here’s a [more comprehensive list](https://en.wikipedia.org/wiki/List_of_unarmed_African_Americans_killed_by_law_enforcement_officers_in_the_United_States), and [here’s a summary article](https://www.apa.org/monitor/2016/12/cover-policing) on policing and race.\
