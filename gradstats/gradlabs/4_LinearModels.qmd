...
3.  **(WE WILL DO THIS TOGETHER). Write a for-loop to estimate how much sampling error might influence this number.** Generate 1000 new samples, and re-calculate the difference between YES and NO + MAYBEs. What percentage of re-sampled groups would show that there are more people who CAN write a for-loop than NOT, MAYBE, or HAD NO IDEA WHAT A FOR-LOOP IS??
