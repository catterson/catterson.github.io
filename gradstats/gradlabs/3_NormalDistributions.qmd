...
hist(d$Q1E, breaks = 100, xlim = c(0,40000),
...
```{r}
plot(selfes[sample(1:nrow(selfes), 100),]$SELFES, # 100 random data points
     ylab = "Self-Esteem (100 Points)",
     xlab = "Index") 
abline(h = mean(selfes$SELFES, na.rm = T), lwd = 0)
```
...
plot(selfes[sample(1:nrow(selfes), 100),]$SELFES, # 100 random data points
     ylab = "Self-Esteem (100 Points)",
     xlab = "Index") 
abline(h = mean(selfes$SELFES, na.rm = T), lwd = 5)
```
...
sd(selfes$SELFES) # slightly higher
