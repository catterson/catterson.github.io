...
1.  Enter in a math equation that used to give you difficulty as a kid to the code block below, and run the code to see the result.

2.  Work with your classmates in section to create another dataframe with three variables - at least one numeric and one "string". Create that dataframe here, and use R code to answer the following questions.
